...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setViewProductMutation(state, payload) {
  ...
  actions: {
      ...
      axios
        ...
        .then((res) => {
          ...
          for (let item of products) {
            ...
            context.state.products = [...loadedProducts];
            context.commit("toggleLoadingMutation", false);
          }
        });
    },
    ...
    setViewProductAction(context, payload) {
      context.commit("setViewProductMutation", payload);
    },
  },
  //GETTERS
  getters: {
